...
注意：图片大小尽量一致，尽量是16 : 9的样式

以 **ImgSea 图床（https://imgsea.com）** 为例（随手找的图床，广告较多，偶尔加载不出来，有更好的图床欢迎推荐！）

**其它图床** （作者也不清楚哪个更好用，可以都试试
...
⚠️注意：不是查看链接（此类没有图片后缀，例如https://imgsea.com/image/QXJf ），一定要是以.jpg .png等结尾的链接
